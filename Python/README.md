...
[**Find PI to the Nth Digit**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/pi.py) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/fib.py) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/primes.py) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/nextprime.py) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/tile.py) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

[**Change Return Program**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/change.py) – The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.

[**Binary to Decimal and Back Converter**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/binaryconverter.py) – Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.

[**Calculator**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/calculator.py) – A simple calculator to do basic operators. Make it a scientific calculator for added complexity.

[**Alarm Clock**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/alarmclock.py) – A simple clock where it plays a sound after X number of minutes/seconds or at a particular time.

[**Credit Card Validator**](https://github.com/joelg236/Projects/blob/master/Python/Numbers/creditcard.py) – Takes in a credit card number from a common credit card vendor (Visa, MasterCard, American Express, Discoverer) and validates it to make sure that it is a valid number (look into how credit cards use a checksum).
...
[**Reverse a String**](https://github.com/joelg236/Projects/blob/master/Python/Text/reverse.py) – Enter a string and the program will reverse it and print it out.

[**Pig Latin**](https://github.com/joelg236/Projects/blob/master/Python/Text/piglatin.py) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](https://github.com/joelg236/Projects/blob/master/Python/Text/vowels.py) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/joelg236/Projects/blob/master/Python/Text/checkpalindrome.py) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](https://github.com/joelg236/Projects/blob/master/Python/Text/wordsinstring.py) – Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.

**Text Editor** – Notepad style application that can open, edit, and save text documents. Add syntax highlighting and other features.

**Vigenere / Vernam / Ceasar Ciphers** – Functions for encrypting and decrypting data messages. Then send them to a friend.

[**Text to HTML Generator**](https://github.com/joelg236/Projects/blob/master/Python/Text/texttohtml.py) – Converts text files into web HTML files and stylizes them. Great for making online documentation of standard text documentation.

[**CD Key Generator**](https://github.com/joelg236/Projects/blob/master/Python/Text/cdkey.py) – Generates a unique key for your applications to use based on some arbitrary algorithm that you can specify. Great for software developers looking to make shareware that can be activated.
...
[**Whois Search Tool**](https://github.com/joelg236/Projects/blob/master/Python/Networking/whois.py) – Enter an IP or host address and have it look it up through whois and return the results to you.
