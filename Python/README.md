...
[**CD Key Generator**](https://github.com/joelg236/Projects/blob/master/Text/cdkey.py) – Generates a unique key for your applications to use based on some arbitrary algorithm that you can specify. Great for software developers looking to make shareware that can be activated.
