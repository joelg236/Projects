...
[**Prime Factorization**](https://github.com/joelg236/Projects/blob/master/Numbers/primes.py) – Have the user enter a number and find all Prime Factors (if there are any) and display them.
